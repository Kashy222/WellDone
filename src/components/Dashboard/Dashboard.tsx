...
export default function Dashboard() {
  ...
  return (
    <div className="w-full h-screen flex flex-col bg-transparent font-sans overflow-hidden">
      
      {/* Global Header */}
      <header className="flex items-center justify-between px-6 py-4 shrink-0 bg-white/30 backdrop-blur-xl z-20 border-b border-white/40 shadow-sm">
      ...
      <main className="flex-1 w-full max-w-[1400px] mx-auto px-4 sm:px-8 py-6 flex flex-col lg:flex-row gap-8 min-h-0 relative z-10 pb-32 lg:pb-6">
        
        {/* Left Pane: Widgets & Tabs */}
        <div className="w-full lg:w-7/12 xl:w-2/3 h-full flex flex-col overflow-y-auto hide-scrollbar pb-24 lg:pb-0 pr-2">
        ...
        <div className="hidden lg:flex lg:w-5/12 xl:w-1/3 h-full flex-col bg-white/20 backdrop-blur-3xl border border-white/40 rounded-3xl p-4 shadow-[0_8px_32px_rgba(31,38,135,0.05)]">

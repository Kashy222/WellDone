...
export default function BottomNav({ activeTab, setActiveTab }: BottomNavProps) {
  return (
    <nav className="flex items-center justify-between gap-2 px-3 py-2 bg-aura-text-primary/95 backdrop-blur-md border border-white/10 rounded-full shadow-[0_8px_32px_rgba(31,38,135,0.2)]">
